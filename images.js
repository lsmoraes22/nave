...
class imageCanvas {
    ...
    resources = [
        ...
        {name: "antiaerea",               src: this.img_src+"antiaerea.png",	        sx:0,	sy:0,	width:35,	height:35	},
        ...
        {name: "btn_center",              src: this.img_src+"btn_center.png",	        sx:0,	sy:0,	width:30,	height:30	},
        {name: "btn_down",                src: this.img_src+"btn_down.png",	          sx:0,	sy:0,	width:30,	height:65	},
        {name: "btn_downleft",            src: this.img_src+"btn_downleft.png",	      sx:0,	sy:0,	width:65,	height:65	},
        {name: "btn_downright",           src: this.img_src+"btn_downright.png",	    sx:0,	sy:0,	width:65,	height:65	},
        {name: "btn_left",                src: this.img_src+"btn_left.png",	          sx:0,	sy:0,	width:65,	height:30	},
        {name: "btn_right",               src: this.img_src+"btn_right.png",	        sx:0,	sy:0,	width:65,	height:30	},
        ...
        {name: "btn_downleft_2",          src: this.img_src+"btn_downleft_2.png",	    sx:0,	sy:0,	width:65,	height:65	},
        {name: "btn_downright_2",         src: this.img_src+"btn_downright_2.png",	  sx:0,	sy:0,	width:65,	height:65	},
        {name: "btn_left_2",              src: this.img_src+"btn_left_2.png",	        sx:0,	sy:0,	width:65,	height:30	},
        {name: "btn_right_2",             src: this.img_src+"btn_right_2.png",	      sx:0,	sy:0,	width:65,	height:30	},
